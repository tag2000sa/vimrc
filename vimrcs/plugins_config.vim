...
map <F3> i#include <stdio.h<ESC>lo<CR><CR>/*File-Name: <C-R>=expand("%:t")<CR><CR>This file was created on <ESC>:r!date "+__/\%b/\%Y"<ESC>kJ<ESC>oSignature: <C-R>=class<CR>.ORIGINAL<CR>Author: <C-R>=author<CR><CR>Subject: <CR><ESC>jo<CR><CR>int main(int argc, char* argv[<ESC>lla{<CR>return 0;<CR><ESC>kO
