#Notice:
original work done by (amix) https://github.com/amix/vimrc I only updated .vimrc files as needed
================================================================================================
...
The awesome version includes a lot of great plugins, configurations and color schemes that make Vim a lot better. To install it simply do following:
	...
	git clone https://github.com/tag2000sa/vimrc.git ~/.vim_runtime
...
This is useful to install on remote servers where you don't need many plugins and you don't do many edits.
	...
	git clone git://github.com/tag200sa/vimrc.git ~/.vim_runtime
